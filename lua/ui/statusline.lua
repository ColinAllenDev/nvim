...
require("ui.highlight").statusline_highlight()
local icon = require("ui.icons")
local is_empty = require("utils").isempty
local is_match = require("utils").ismatch
local devicon = require("utils").get_icons
-- Add filetypes to the list for which you don't want statusline before unpack statement
local disable_statusline = {
  "TelescopePrompt",
  "lazy",
  "NvimTree",
  unpack(require("utils").disable() or {}),
}
